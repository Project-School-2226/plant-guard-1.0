...
void _filterPlants() {
  ...
  return InkWell(
    onTap: () => showPlantDetails(context, filteredPlantsInfo[index]["name"]!, filteredPlantsInfo[index]["details"]!),
    child: Card(
